...
public class Utils {
    public static void logPrint(String strLog) {
        ...
        try {
			...
			extentTest.log(Status.INFO, strLog,	
					MediaEntityBuilder.createScreenCaptureFromPath(System.getProperty("user.dir") + "/src/test/resources/report/" + strLog + ".png")
                    .build());
		} catch (IOException e) {
    ...
    public static void efetuarPrintTela(String strLog) {
		...
		try {
			FileUtils.copyFile(scrFile, new File("C:/Users/ruehlein/eclipse-workspace/foradacaixa/src/test/resources/report/" + strLog + ".png"));
